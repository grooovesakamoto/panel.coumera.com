// JavaScript版のシードスクリプト
// TypeScriptのコンパイルが必要ないため、Cloud Runで実行するのに最適

// Node.jsのメモリ設定を構成
const v8 = require('v8');
// メモリ使用量を制限するための設定
// デフォルトのGCパラメータを調整して、メモリを節約
v8.setFlagsFromString('--max_old_space_size=1536');

// 必要なモジュールを読み込む
const { PrismaClient } = require('@prisma/client');
const bcrypt = require('bcryptjs');

console.log('Starting seed script (JavaScript version)...');
